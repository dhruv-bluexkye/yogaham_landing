  ...
  return (
    <div className="min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center bg-surface-light/80 dark:bg-surface-dark/80 backdrop-blur-md px-6 py-3 rounded-full shadow-sm border border-gray-100 dark:border-gray-800">
          ...
          <div className="hidden md:flex space-x-8 text-sm font-medium text-text-muted-light dark:text-text-muted-dark">
            ...
            <a className="hover:text-primary transition-colors" href="#plans">Plans</a>
          </div>
          <div className="flex items-center space-x-4">
            <button className="hidden md:flex items-center space-x-2 text-sm font-medium hover:text-primary transition-colors">
              <span>Contact</span>
      ...
      <header id="home" className="relative pt-32 pb-20 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 z-10 space-y-8">
            <h1 className="text-6xl md:text-7xl font-light leading-[1.1] tracking-tight text-text-main-light dark:text-text-main-dark">
              Find Peace <br />
              Through <span className="font-normal italic text-primary font-display">Mindful</span> <br />
              Movement
            </h1>
            <p className="text-lg text-text-muted-light dark:text-text-muted-dark max-w-md font-light leading-relaxed">
            ...
            <div className="flex items-center gap-4">
              <button className="bg-primary hover:bg-primary-dark text-white px-8 py-3 rounded-full transition-all duration-300 flex items-center gap-2 group">
                Start Journey
                <span className="material-icons-outlined group-hover:translate-x-1 transition-transform text-sm">arrow_forward</span>
              </button>
              <button className="px-6 py-3 rounded-full border border-gray-200 dark:border-gray-700 hover:border-primary dark:hover:border-primary transition-colors flex items-center gap-2">
                Learn More
          ...
          <div className="lg:col-span-5 relative flex justify-center z-10">
            ...
            <img 
              alt="Yoga Silhouette" 
              className="relative z-10 w-full max-w-md h-[500px] object-cover rounded-t-[10rem] rounded-b-[3rem] shadow-2xl dark:shadow-none grayscale-[20%] hover:grayscale-0 transition-all duration-500" 
          ...
          <div className="lg:col-span-2 hidden lg:flex flex-col gap-6 justify-center items-end">
            {[
              ...
              <div key={idx} className={`relative group cursor-pointer ${idx === 1 ? 'translate-x-4' : ''}`}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <img 
                alt="Yoga Community" 
                className="relative rounded-2xl shadow-xl w-full object-cover h-[500px] grayscale-[10%]" 
            ...
            <div className="space-y-6">
              ...
              <button className="group flex items-center gap-3 text-text-main-light dark:text-text-main-dark font-medium mt-4">
                <span className="bg-gray-100 dark:bg-gray-800 group-hover:bg-primary group-hover:text-white transition-colors p-3 rounded-full">
      ...
      <section id="services" className="py-24 px-6 relative overflow-hidden bg-background-light dark:bg-background-dark">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center pointer-events-none select-none z-0">
          <span className="text-[10vw] md:text-[15vw] font-bold text-gray-100 dark:text-gray-800/20 opacity-60">YOGAHAM</span>
        </div>
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {SERVICES.map((service) => (
              <div 
                key={service.id} 
                className={`bg-white dark:bg-surface-dark p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 ${service.offset ? 'md:translate-y-12' : ''}`}
              >
                <h3 className="text-2xl font-medium mb-4" dangerouslySetInnerHTML={{ __html: service.title.replace(' ', '<br/>') }} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {EXPERTS.map((expert) => (
              <div key={expert.id} className="group cursor-pointer">
                <div className="overflow-hidden rounded-2xl mb-6 bg-gray-100 dark:bg-gray-800">
                  <img 
                    alt={expert.name} 
                ...
                <div className="text-center">
                  <h4 className="text-xl font-medium">{expert.name}</h4>
      ...
      <section id="classes" className="py-24 px-6 bg-background-light dark:bg-background-dark">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="lg:sticky lg:top-32 h-fit">
            ...
            <button className="flex items-center gap-3 px-6 py-3 rounded-full border border-gray-300 dark:border-gray-700 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors">
              See All Classes
              <span className="material-icons-outlined text-sm">north_east</span>
            </button>
          </div>
          <div className="space-y-4">
            {CLASSES.map((cls) => (
              <div key={cls.id} className="bg-white dark:bg-surface-dark p-8 rounded-2xl flex flex-col md:flex-row gap-6 items-start hover:shadow-md transition-shadow">
      ...
      <section id="plans" className="py-24 px-6 bg-white dark:bg-surface-dark">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-light text-center mb-16">Flexible Plans for Every Lifestyle</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {PLANS.map((plan) => (
              <div 
                key={plan.id} 
                className={`p-8 rounded-2xl border transition-colors group relative ${
                  plan.isPopular 
                  ? 'bg-background-light dark:bg-background-dark border-primary shadow-lg transform md:-translate-y-4' 
                  : 'bg-background-light dark:bg-background-dark border-transparent hover:border-primary'
                }`}
              >
                {plan.isPopular && (
                  <div className="absolute top-0 right-0 bg-primary text-white text-[10px] font-bold px-3 py-1 rounded-bl-xl rounded-tr-xl uppercase">Most Popular</div>
                )}
                <div className="w-12 h-12 rounded-full bg-white dark:bg-surface-dark flex items-center justify-center mb-6 shadow-sm">
      ...
      <section className="py-24 px-6 relative bg-background-light dark:bg-background-dark">
        <div className="max-w-4xl mx-auto text-center">
          <span className="material-icons-outlined text-6xl text-gray-200 dark:text-gray-800 rotate-180 absolute left-10 md:left-20 top-20">format_quote</span>
          ...
          <div className="flex flex-col items-center">
            <img 
              alt="User" 
              className="w-16 h-16 rounded-full object-cover mb-3 border-2 border-primary p-1" 
      ...
      <footer className="bg-white dark:bg-surface-dark pt-20 pb-10 px-6 border-t border-gray-100 dark:border-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <form className="relative" onSubmit={(e) => e.preventDefault()}>
                <input 
                  className="w-full bg-background-light dark:bg-background-dark border-none rounded-full py-3 pl-4 pr-12 text-sm focus:ring-1 focus:ring-primary" 
          ...
          <div className="w-full text-center mt-12 opacity-10 dark:opacity-5 overflow-hidden select-none pointer-events-none">
            <span className="text-[12vw] font-bold leading-none tracking-tighter text-gray-900 dark:text-gray-100">YOGAHAM</span>
          </div>
        </div>
      </footer>
    </div>
